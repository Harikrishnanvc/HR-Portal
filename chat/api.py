...
class MessageModelViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        recipient = AdminUser.objects.get(username=target)
        notify.send(user, recipient=recipient, verb='Message', description=request.POST.get('message'))
...
class UserModelViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        print("inside list")
        self.queryset = self.queryset.exclude(user_id=request.user.user_id)
